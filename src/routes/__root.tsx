  ...
  head: () => ({
    meta: [
      ...
      { title: "Calix Multispeciality Hospital | Complete Family Healthcare" },
      {
        name: "description",
        content:
          "Calix Multispeciality Hospital delivers expert care across ten specialties with advanced diagnostics, modern infrastructure and 24×7 emergency support.",
      },
      { name: "author", content: "Calix Multispeciality Hospital" },
  ...
  return (
    <QueryClientProvider client={queryClient}>
      <div className="flex min-h-screen flex-col">
        <Header />
        <main className="flex-1" style={{ paddingTop: "var(--header-height, 135px)" }}>
