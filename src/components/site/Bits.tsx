  ...
  return (
    <section className="relative overflow-hidden bg-primary-deep py-16 text-primary-foreground lg:py-24">
      ...
      <div className="container-page relative">
        ...
        <h1 className="mt-4 max-w-3xl text-3xl font-bold leading-[1.1] sm:text-4xl lg:text-5xl">
          {title}
        </h1>
        {subtitle ? (
...
export function SectionHeading({
  ...
  return (
    <div className={align === "center" ? "mx-auto max-w-2xl text-center" : "max-w-2xl"}>
      ...
      <h2 className="mt-3 text-2xl font-bold leading-tight text-foreground sm:text-3xl lg:text-4xl">
        {title}
      </h2>
